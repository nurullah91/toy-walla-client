...
const SendGift = () => {
    return (
        <div className="w-11/12 lg:9/12 mx-auto my-10">
             <h3 className="text-center text-4xl font-bold text-rose-500 mb-1">Send gift by us</h3>
             <p className="text-center text-slate-600 font-semibold">You can order and send gift via us. Our team will deliver your gift with excellent package</p>
